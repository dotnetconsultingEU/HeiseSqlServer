...
-- Änderungen an der Tabelle möglich?
DROP TABLE [dbo].[Tickets]; -- Fehler
ALTER TABLE [dbo].[Tickets] DROP COLUMN TraceID; -- Fehler
ALTER TABLE dbo.Tickets ADD Username varchar(50) NULL; -- OK
